...
public class MigrationHelper {
    ...
    private static final String SQLITE_MASTER = "largeui-db";
    private static final String SQLITE_TEMP_MASTER = "largeui-db-temp";
    ...
    public void migrate(SQLiteDatabase db, Class<? extends AbstractDao<?, ?>>... daoClasses) {
        migrate(new StandardDatabase(db), daoClasses);
    }
    ...
    private void generateTempTables(Database db, Class<? extends AbstractDao<?, ?>>... daoClasses) {
        for (int i = 0; i < daoClasses.length; i++) {
            ...
            Log.w(TAG, "generateTempTables: sql:" + insertTableStringBuilder.toString());
        }
    }
