...
public class DateUtils {
    ...
    private static final SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyyMMddHHmmss");//设置日期格式


    private static final SimpleDateFormat dateformat = new SimpleDateFormat("HH:mm");//设置日期格式
    ...
    public static String parseMillisToString(long time) {
...
//        return LongFormatTime(format.format(new Date(Long.valueOf(seconds))));
    ...
    public static float getHourOfDay(String dateString) {
        float hour = 0f;
        try {
            DateTime dateTime = new DateTime(format.parse(dateString));
            hour = dateTime.getHourOfDay();
        } catch (ParseException e) {
            e.printStackTrace();
        }
        Log.i(TAG,"getHourOfDay hour : " + hour);
        return hour;
    }

    public static float getDayOfWeek(String dateString) {
        float dayOfweek = 0f;
        try {
        ...
        Log.i(TAG,"getDayOfWeek dayOfweek : " + dayOfweek);
        return dayOfweek;
    }

    public static float getDayOfMonth(String dateString) {
        float day = 0f;
        try {
            DateTime dateTime = new DateTime(format.parse(dateString));
        ...
        Log.i(TAG,"getDayOfMonth day : " + day);
        return day;
    }
    ...
    public static void main(String[] args) {
        SimpleDateFormat sdf = new SimpleDateFormat("MMM d, yyyy KK:m:s a", Locale.ENGLISH);
        Date d2 = null;
        try {
            d2 = sdf.parse("Sep 29, 2012 11:00:01 AM");
        } catch (ParseException e) {
            e.printStackTrace();
        }
        Date d3 = new Date();
