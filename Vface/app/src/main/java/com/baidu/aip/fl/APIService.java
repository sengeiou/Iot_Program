...
import com.baidu.aip.fl.model.FaceListParams;
import com.baidu.aip.fl.model.RegParams;
import com.baidu.aip.fl.parser.FaceListParser;
...
public class APIService {
    ...
    private static final String FACE_LIST_URL = BASE_URL + "/rest/2.0/face/v3/faceset/face/getlist";

    private static final String DELETE_FACE_URL = BASE_URL + "/rest/2.0/face/v3/faceset/face/delete";

    private static final String DELETE_GROUP_URL = BASE_URL + "/rest/2.0/face/v3/faceset/group/delete";
     ...
     * 获取用户人脸列表
     */
    public void getFaceList(OnResultListener listener, String uid) {
        FaceListParams params = new FaceListParams();
        params.setUserId(uid);
        params.setGroupId(groupId);
        FaceListParser parser = new FaceListParser();
        String url = urlAppendCommonParams(FACE_LIST_URL);
        HttpUtil.getInstance().post(url, params, parser, listener);
    }
     ...
     * 删除用户人脸
     */
    public void deleteFace(OnResultListener listener, String uid,String faceToken) {
        FaceListParams params = new FaceListParams();
        params.setUserId(uid);
        params.setGroupId(groupId);
        ...
        String url = urlAppendCommonParams(DELETE_FACE_URL);
        HttpUtil.getInstance().post(url, params, parser, listener);
    }
     ...
     * 删除用户组下所有的用户及人脸
     */
    public void deleteFaceGroup(OnResultListener listener) {
        FaceListParams params = new FaceListParams();
        ...
        String url = urlAppendCommonParams(DELETE_GROUP_URL);
        HttpUtil.getInstance().post(url, params, parser, listener);
    }
