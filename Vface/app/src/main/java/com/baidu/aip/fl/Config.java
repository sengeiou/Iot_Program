...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "UIxaQ6qwCm3wEIn2FaPMEYrB";
    public static String secretKey = "kdSwcG7AVGwUgTTFRng4oKZKAuirI5fH";
    public static String licenseID = "vtech-sp01-face-android";
     ...
     */
    public static String groupID = "adc";
