...
import com.vtech.vhealth.function.bean.EcgBean;
...
import com.vtech.vhealth.function.widget.EcgAlertDialog;
import com.vtech.vhealth.function.widget.EcgHrvAlertDialog;

import com.vtech.vhealth.serial.SerialPortUtil;
...
public class EcgFragment extends BaseFragment<EcgDelegate> implements View.OnClickListener {
    ...
    private void initView() {
        ...
        hrvTvs.setOnClickListener(this);
        hrTv.setOnClickListener(this);
...
//                        sqText.setText(sqStr);
                        sqTitle.setText(String.format(getString(R.string.str_signal), sqStr));
                    }
                });
            }
...
//        sqTitle.setText("Signal Quality: NONE");
        sqTitle.setText(String.format(getString(R.string.str_signal), "NONE"));
...
//        if (bRunning) {
    ...
    private  EcgAlertDialog mEcgAlertDialog;

    @Override
    public void onClick(View view) {
        if (mEcgAlertDialog == null) {
            mEcgAlertDialog=   new EcgAlertDialog(getActivity(), R.style.customDialog)
                    .setPositiveButton(getActivity().getString(R.string.str_know), new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
