...
import com.vtech.vhealth.function.bean.HealthDTO;
import com.vtech.vhealth.function.provider.DbOpenHelper;
import com.vtech.vhealth.function.provider.SerialProvider;
import com.vtech.vhealth.function.pserial.SerialPortUtil;
...
public class BpressureUtil {
    ...
    //数据采集循环周期 1S
    private static final int SON_DATA_CYCLE_TIME = 200;
    private static final int SON_SIGN_CYCLE_TIME = 200;
    private static final int SON_SIGN_PLUSE_TIME = 100;
    ...
    private Integer[] arrPluse=new Integer[1];
...
//                    Log.d(TAG, "healthRunnable： SON_MSG_PLUS_UPDATE。 " + msg.what);
                    ...
                    sendEmptyMessageDelayed(SON_MSG_PLUS_UPDATE, SON_SIGN_PLUSE_TIME);
                    break;
