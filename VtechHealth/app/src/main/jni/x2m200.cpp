...
Java_com_vtech_vhealth_serial_SerialPort_lightcontrol
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vtech_vhealth_serial_SerialPort_cribrate
...
Java_com_vtech_vhealth_serial_SerialPort_BPressure
...
Java_com_vtech_vhealth_serial_SerialPort_open
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vtech_vhealth_serial_SerialPort_close(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_vtech_vhealth_function_pserial_SerialPort_open(JNIEnv *env, jclass thiz, jstring path, jint baudrate, jint flags)
{
    int fd;
    speed_t speed;
    jobject mFileDescriptor;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vtech_vhealth_function_pserial_SerialPort_close(JNIEnv *env, jobject thiz)
{
    jclass SerialPortClass = env->GetObjectClass(thiz);
    jclass FileDescriptorClass = env->FindClass("java/io/FileDescriptor");
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vtech_vhealth_function_pserial_SerialPort_devOn(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vtech_vhealth_function_pserial_SerialPort_devOff(JNIEnv *env, jobject thiz) {
    int fd = open(DEV_XINLV, O_RDWR);
    int value = 0;
    int result =  ioctl(fd, XINLV_ENABLE_XINLV, &value);
    LOGD(" on (fd = %d DEV_XINLV = %s  result= %d)", fd,DEV_XINLV ,result);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vtech_vhealth_serial_SerialPort_devOn(JNIEnv *env, jobject thiz) {
    int fd = open(DEV_XINLV, O_RDWR);
    int value = 1;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vtech_vhealth_serial_SerialPort_devOff(JNIEnv *env, jobject thiz) {
    int fd = open(DEV_XINLV, O_RDWR);
    int value = 0;
    int result =  ioctl(fd, XINLV_ENABLE_XINDI, &value);
